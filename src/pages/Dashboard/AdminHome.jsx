                ...
                <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md text-center transition-transform transform hover:scale-105">
                        ...
                        <Link to="/dashboard/manageItems">
                            <button className="mt-4 bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 focus:outline-none">Manage Meals</button>
                        </Link>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md text-center transition-transform transform hover:scale-105">
                        ...
                        <Link to="/dashboard/addItems">
                            <button className="mt-4 bg-purple-600 text-white py-2 px-4 rounded-lg hover:bg-purple-700 focus:outline-none">Add Meal</button>
                        </Link>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md text-center transition-transform transform hover:scale-105">
                        ...
                        <Link to="/dashboard/users">
                            <button className="mt-4 bg-green-600 text-white py-2 px-4 rounded-lg hover:bg-green-700 focus:outline-none">Manage Users</button>
                        </Link>
                    </div>
